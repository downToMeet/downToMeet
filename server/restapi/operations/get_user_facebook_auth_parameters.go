...
// NewGetUserFacebookAuthParams creates a new GetUserFacebookAuthParams object
// no default values defined in spec.
func NewGetUserFacebookAuthParams() GetUserFacebookAuthParams {

	return GetUserFacebookAuthParams{}
}

// GetUserFacebookAuthParams contains all the bound params for the get user facebook auth operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetUserFacebookAuth
type GetUserFacebookAuthParams struct {
