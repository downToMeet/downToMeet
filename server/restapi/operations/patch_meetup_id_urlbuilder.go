...
func (o *PatchMeetupIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on PatchMeetupIDURL")
	}
...
func (o *PatchMeetupIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchMeetupIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchMeetupIDURL")
	}
