...
type PatchUserIDHandlerFunc func(PatchUserIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchUserIDHandlerFunc) Handle(params PatchUserIDParams) middleware.Responder {
	return fn(params)
}

// PatchUserIDHandler interface for that can handle valid patch user ID params
type PatchUserIDHandler interface {
	Handle(PatchUserIDParams) middleware.Responder
}
