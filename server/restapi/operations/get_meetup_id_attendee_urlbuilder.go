...
type GetMeetupIDAttendeeURL struct {
	ID string
...
func (o *GetMeetupIDAttendeeURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetMeetupIDAttendeeURL")
	}
...
func (o *GetMeetupIDAttendeeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMeetupIDAttendeeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMeetupIDAttendeeURL")
	}
