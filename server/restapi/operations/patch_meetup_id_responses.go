...
// PatchMeetupIDInternalServerErrorCode is the HTTP code returned for type PatchMeetupIDInternalServerError
const PatchMeetupIDInternalServerErrorCode int = 500

/*PatchMeetupIDInternalServerError Internal server error

swagger:response patchMeetupIdInternalServerError
*/
type PatchMeetupIDInternalServerError struct {
...
// NewPatchMeetupIDInternalServerError creates PatchMeetupIDInternalServerError with default headers values
func NewPatchMeetupIDInternalServerError() *PatchMeetupIDInternalServerError {

	return &PatchMeetupIDInternalServerError{}
}

// WithPayload adds the payload to the patch meetup Id internal server error response
func (o *PatchMeetupIDInternalServerError) WithPayload(payload *models.Error) *PatchMeetupIDInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the patch meetup Id internal server error response
func (o *PatchMeetupIDInternalServerError) SetPayload(payload *models.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *PatchMeetupIDInternalServerError) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
