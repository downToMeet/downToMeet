...
func NewPatchUserIDParams() PatchUserIDParams {
	...
	return PatchUserIDParams{}
}

// PatchUserIDParams contains all the bound params for the patch user ID operation
...
func (o *PatchUserIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
