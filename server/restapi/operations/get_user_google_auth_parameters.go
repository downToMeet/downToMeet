...
// NewGetUserGoogleAuthParams creates a new GetUserGoogleAuthParams object
// no default values defined in spec.
func NewGetUserGoogleAuthParams() GetUserGoogleAuthParams {

	return GetUserGoogleAuthParams{}
}

// GetUserGoogleAuthParams contains all the bound params for the get user google auth operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetUserGoogleAuth
type GetUserGoogleAuthParams struct {
