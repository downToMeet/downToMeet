...
type PostMeetupIDAttendeeURL struct {
	ID string
...
func (o *PostMeetupIDAttendeeURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on PostMeetupIDAttendeeURL")
	}
...
func (o *PostMeetupIDAttendeeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostMeetupIDAttendeeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostMeetupIDAttendeeURL")
	}
