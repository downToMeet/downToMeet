...
// NewGetMeetupIDParams creates a new GetMeetupIDParams object
// no default values defined in spec.
func NewGetMeetupIDParams() GetMeetupIDParams {

	return GetMeetupIDParams{}
}

// GetMeetupIDParams contains all the bound params for the get meetup ID operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetMeetupID
type GetMeetupIDParams struct {
...
func (o *GetMeetupIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
