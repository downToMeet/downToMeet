...
// DeleteMeetupIDInternalServerErrorCode is the HTTP code returned for type DeleteMeetupIDInternalServerError
const DeleteMeetupIDInternalServerErrorCode int = 500

/*DeleteMeetupIDInternalServerError Internal server error

swagger:response deleteMeetupIdInternalServerError
*/
type DeleteMeetupIDInternalServerError struct {
...
// NewDeleteMeetupIDInternalServerError creates DeleteMeetupIDInternalServerError with default headers values
func NewDeleteMeetupIDInternalServerError() *DeleteMeetupIDInternalServerError {

	return &DeleteMeetupIDInternalServerError{}
}

// WithPayload adds the payload to the delete meetup Id internal server error response
func (o *DeleteMeetupIDInternalServerError) WithPayload(payload *models.Error) *DeleteMeetupIDInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete meetup Id internal server error response
func (o *DeleteMeetupIDInternalServerError) SetPayload(payload *models.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteMeetupIDInternalServerError) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
