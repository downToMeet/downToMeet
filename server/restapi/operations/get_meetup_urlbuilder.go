...
func (o *GetMeetupURL) Build() (*url.URL, error) {
	...
	radiusQ := swag.FormatFloat64(o.Radius)
	if radiusQ != "" {
		qs.Set("radius", radiusQ)
	}
...
func (o *GetMeetupURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMeetupURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMeetupURL")
	}
