...
// GetMeetupIDInternalServerErrorCode is the HTTP code returned for type GetMeetupIDInternalServerError
const GetMeetupIDInternalServerErrorCode int = 500

/*GetMeetupIDInternalServerError Internal server error

swagger:response getMeetupIdInternalServerError
*/
type GetMeetupIDInternalServerError struct {
...
// NewGetMeetupIDInternalServerError creates GetMeetupIDInternalServerError with default headers values
func NewGetMeetupIDInternalServerError() *GetMeetupIDInternalServerError {

	return &GetMeetupIDInternalServerError{}
}

// WithPayload adds the payload to the get meetup Id internal server error response
func (o *GetMeetupIDInternalServerError) WithPayload(payload *models.Error) *GetMeetupIDInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get meetup Id internal server error response
func (o *GetMeetupIDInternalServerError) SetPayload(payload *models.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetMeetupIDInternalServerError) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
